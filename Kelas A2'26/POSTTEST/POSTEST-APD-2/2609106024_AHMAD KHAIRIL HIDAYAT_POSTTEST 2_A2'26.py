...
print("Total Berat Akhir Bagasi Adalah : ", Total_Berat_Akhir_Fix,"gram"), print("Rata-Rata Berat Bagasi Adalah : ", Rata_Rata,"Kg"), print("Kompensasi Adalah : ", Kompensasi,"Kg"), print("Jumlah Data Bagasi Adalah : ", Jumlah_Data), print("NIM : ", NIM), print("Apakah NIM Lebih Kecil dari Rata-Rata? : ", Bolean), print("berat bagasi milik para penumpang tengah adalah : ", Bagasi[2:5])